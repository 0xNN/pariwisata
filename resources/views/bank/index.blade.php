                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dt-bank" class="table table-bordered dt-responsive nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>ID</th>
...
<script>
    ...
    $(document).ready(function() {
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('bank.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-bank').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
          ...
          $.get('bank/' + data_id + '/edit', function (data) {
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('bank.destroy', ":dataId") }}";
