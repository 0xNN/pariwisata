                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dt-lokasi" class="table table-bordered dt-responsive nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>ID</th>
...
<script>
    ...
    $(document).ready(function() {
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        timeout: 600000,
                        url: "{{ route('lokasi.store') }}", //url simpan data
                        type: "POST", //karena simpan kita pakai method POST
                        success: function (data) { //jika berhasil
                            $('#form-tambah-edit').trigger("reset"); //form reset
                            $('#addUtamaModal').modal('hide'); //modal hide
                            $('#tombol-simpan').html('Simpan'); //tombol simpan
                            var oTable = $('#dt-lokasi').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('lokasi/' + data_id + '/edit', function (data) {
                ...
                $(`select#hotel_id option[value='${data.hotel_id}']`).attr('selected','selected');
            })
        });
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('lokasi.destroy', ":dataId") }}";
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#dt-lokasi').dataTable();
                    oTable.fnDraw(false); //reset datatable
                });
