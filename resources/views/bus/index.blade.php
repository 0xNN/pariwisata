                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dt-bus" class="table table-bordered dt-responsive nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>ID</th>
    ...
    $(document).ready(function() {
        var table = $('#dt-bus').DataTable({
            ...
            columns: [
                ...
                {data: 'id', name: 'id'},
                {data: 'nama_bus', name: 'nama_bus'},
                {data: 'jenis_bus_id', name: 'jenis_bus_id'},
                {data: 'minimum_pack', name: 'minimum_pack'},
                {data: 'maksimum_pack', name: 'maksimum_pack'},
        ...
        $("#tombol-upload-image").click(function (event) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var oTable = $('#dt-bus').dataTable(); //inialisasi datatable
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('bus.store') }}", //url simpan data
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('bus/' + data_id + '/edit', function (data) {
                ...
                $('#id').val(data.id);
                $(`#jenis_bus_id option[value=${data.jenis_bus_id}]`).attr('selected','selected');
                $('#nama_bus').val(data.nama_bus);
                $('#minimum_pack').val(data.minimum_pack);
                $('#maksimum_pack').val(data.maksimum_pack);
            })
        });
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('bus.destroy', ":dataId") }}";
