                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dt-note" class="table table-bordered dt-responsive nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>ID</th>
    ...
    $(document).ready(function() {
        var table = $('#dt-note').DataTable({
            ...
            columns: [
                ...
                {data: 'status_termasuk', name: 'status_termasuk'},
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('note.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#dt-note').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('note/' + data_id + '/edit', function (data) {
                ...
                $(`select#status_termasuk option[value='${data.status_termasuk}']`).prop('selected',true);
            })
        });
        ...
        $('#tombol-utama-hapus').click(function () {
            var url = "{{ route('note.destroy', ":dataId") }}";
