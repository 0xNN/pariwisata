                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dt-pesawat" class="table table-bordered dt-responsive nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>ID</th>
    ...
    $(document).ready(function() {
        ...
        $("#tombol-upload-image").click(function (event) {
            ...
            $.ajax({
                ...
                url: "{{ route('pesawat_detail.store') }}",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
                ...
                success: function (data) {
                    ...
                    var oTable = $('#dt-pesawat').dataTable(); //inialisasi datatable
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('pesawat.store') }}", //url simpan data
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('pesawat/' + data_id + '/edit', function (data) {
